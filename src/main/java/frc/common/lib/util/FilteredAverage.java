...
public class FilteredAverage {
   ...
   *               the list is applied to the oldest number in the average.
   *               Running average length matches the length
   *               of the gains.
   */
   ...
   * @return a running average that should contains the last pTime seconds' worth
   *         of data
   */
