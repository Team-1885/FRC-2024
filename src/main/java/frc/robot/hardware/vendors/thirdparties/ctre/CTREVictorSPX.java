  ...
  public static void logFaults(VictorSPX CTREVictorSPX) {
    ...
    if (CTRE_0xF.hasAnyFault()) {
      ...
      if (CTRE_0xF.ResetDuringEn) {
        System.out.println(separator);
        logger.log(null, "// ",
            Level.SEVERE + "Device was powered-on or reset while robot is enabled. Check your breakers and wiring.");
        System.out.println(separator);
      }
      ...
      if (CTRE_0xF.SupplyUnstable) {
        System.out.println(separator);
        logger.log(null, "// ",
            Level.SEVERE + "Supply is rapidly fluctuating and unstable. This fault is specific to Brushless.");
        System.out.println(separator);
      }
