...
import frc.common.lib.util.FilteredAverage;
...
public abstract class IMU {
  ...
  public void update() {
    ...
    mJerkX = (currentAccelX - mAccelerationX.getAverage()) / (mClock.deltaTime());
    mJerkY = (currentAccelY - mAccelerationY.getAverage()) / (mClock.deltaTime());
