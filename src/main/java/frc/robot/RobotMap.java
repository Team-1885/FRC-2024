...
/**
 * Provides a convenient place for teams to hold robot-wide numerical or boolean constants.
...
@SuppressWarnings({"PMD.CommentSize", "PMD.LongVariable"}) public final class RobotMap {
  ...
  /**
   * Contains the port numbers for each of the different types of controllers.
   */
  ...
  /**
   * Provides button mappings to different FIRST approved controllers 
   * @see <a href="https://docs.wpilib.org/en/stable/docs/software/basic-programming/joystick.html">WPILib</a>
   */
